 ...
 * @author admin
 */
public class Caique_clientes extends javax.swing.JFrame {

    /**
     * Creates new form Caique_clientes
     */
    public Caique_clientes() {
        initComponents();
    }
    ...
    private void initComponents() {
        ...
        jLabel6.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/7.png"))); // NOI18N
        jLabel6.setBorder(javax.swing.BorderFactory.createEtchedBorder(new java.awt.Color(255, 204, 102), null));
        ...
        jLabel7.setIcon(new javax.swing.ImageIcon(getClass().getResource("/imagens/ds_2.png"))); // NOI18N
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Nome", "Cpf", "RG", "Horario de Entrada"
            }
        ) {
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Caique_clientes.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new Caique_clientes().setVisible(true);
            }
        });
    }
